...
\begin{figure}[h!]
\centering
\includegraphics[width=15cm, height=9cm, inner]{../../bld/out/figures/occupation_count.png}
\caption{Frequency Distribution of Occupation by Gender}
\label{fig:figure1}
\end{figure}
\begin{flushleft}

\footnotesize1 : Higher Level Managerial workers \hspace{4mm }2: Lower level Managerial Workers\\
\footnotesize3: Routine Workers \hspace{26mm} 4: Manual Workers\\
\end{flushleft}
\newpage

\begin{figure}[h!]
\centering
\includegraphics[width=15cm, height=9cm, inner]{../../bld/out/figures/heatmap.png}
\caption
\label{Figure 2}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=15cm, height=9cm, inner]{../../bld/out/figures/distplot.png}
\caption{Distribution of Personality traits and Cognitive abilities}
\label{fig:figure1}
\end{figure}
